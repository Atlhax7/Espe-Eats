...
public class pnlConcesionarias extends javax.swing.JPanel {
     ...
     */
    ConcesionariaDAO condao = new ConcesionariaDAO();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        String IdConcesionario = jTextField1.getText();
        ...
        if (NumberUtils.isCreatable(jTextField2.getText())) {
        if (NumberUtils.isCreatable(jTextField1.getText())) {
            if (!validarCamposVacios()) {
                ...
                condao.ActualizarUsuario(IdUsuario,usuario);
            } else {
                ...
                JOptionPane.showMessageDialog(null, "El teléfono no es un número");
            }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (NumberUtils.isCreatable(jTextField2.getText())) {
            if(jTextField11.getText().isEmpty()){
                ...
                condao.Leer(IdUsuario,jTextField1,jTextField3,jTextField4,jTextField2);} else {
                JOptionPane.showMessageDialog(null,"Existen campos vacíos, por favor revise nuevamente los datos");
            }} else {
                JOptionPane.showMessageDialog(null, "El id no es un número");
            }} else {
    ...
    private boolean validarCamposVacios() {
        return jTextField1.getText().isEmpty() || jTextField2.getText() == null
                || jTextField3.getText().isEmpty() || jTextField4.getText() == null|| jComboBox1.getSelectedItem()== null;
    }
